...
<footer>
  <div class="wrap">
    ...
    <div class="footer-social">
      <a href="https://www.facebook.com/projonmo.foundation.2022" target="_blank" rel="noopener noreferrer" aria-label="Facebook">📘 <span class="bn">ফেসবুক</span><span class="en">Facebook</span></a>
      <a href="https://www.instagram.com/projonmo_foundation.2022" target="_blank" rel="noopener noreferrer" aria-label="Instagram">📸 <span class="bn">ইনস্টাগ্রাম</span><span class="en">Instagram</span></a>
...
def main() -> None:
    ...
    for name in ("config.js", "settings.js", "storage.js", "common.js", "auth.js"):
    ...
    (ROOT / "admin.html").write_text(
        page(ADMIN_HEAD, f"{ADMIN_NAV}\n\n{section}\n\n{footer}",
             ["config.js", "settings.js", "storage.js", "common.js", "auth.js", "admin.js"], vendor),
        encoding="utf-8",
    )
